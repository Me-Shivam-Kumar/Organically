...
import com.organically.organically.adapter.MainAdapter
import com.organically.organically.fragment.FragmentNextDays
import com.organically.organically.model.ModelMain
import com.organically.organically.networking.ApiEndpoint
...
class WeatherActivity : AppCompatActivity(),LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvListWeather.setLayoutManager(LinearLayoutManager(this@WeatherActivity, LinearLayoutManager.HORIZONTAL, false))
                    ...
                    override fun onResponse(response: JSONObject) {
                        try {
                            ...
                            if (strDescWeather == "broken clouds") {
                                ...
                                tvWeather.text = "Heavy intensity rain"
                            ...
                            tvKecepatanAngin.text = "Wind Speed $strKecepatanAngin km/hr"
                            tvKelembaban.text = "Humidity $strKelembaban %"
                        } catch (e: JSONException) {
                            e.printStackTrace()
                            Toast.makeText(this@WeatherActivity, "Failed to display data!", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onError(anError: ANError) {
                        Toast.makeText(this@WeatherActivity, "No signal", Toast.LENGTH_SHORT).show()
                    }
                })
    }
    ...
    private fun checkIfAlreadyhavePermission(): Boolean {
        val result = ContextCompat.checkSelfPermission(this@WeatherActivity, Manifest.permission.ACCESS_FINE_LOCATION)
        return result == PackageManager.PERMISSION_GRANTED
    }

    private fun checkIfAlreadyhavePermission2(): Boolean {
        val result = ContextCompat.checkSelfPermission(this@WeatherActivity, Manifest.permission.ACCESS_COARSE_LOCATION)
        return result == PackageManager.PERMISSION_GRANTED
    }
